  ...
  return (
    <SectionWrapper id="interests">
      ...
      <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-balance theme-text">
        Beyond the <span className="accent-text">code</span>
      </h2>
        ...
        {interestsData.map((interest, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="absolute inset-0 accent-bg opacity-0 group-hover:opacity-5 transition-opacity duration-500"
              />

              <div className="relative z-10">
                <div
                  className="w-11 h-11 rounded-xl accent-bg flex items-center justify-center mb-4 opacity-80 group-hover:opacity-100 transition-opacity"
                >
                  <Icon className="w-5 h-5 text-white" />
                </div>
                <h3 className="font-display font-semibold theme-text text-base sm:text-lg mb-1">
                  {interest.title}
                </h3>
                <p className="text-xs sm:text-sm theme-text-quaternary leading-relaxed">
