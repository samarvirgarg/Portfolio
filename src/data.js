...
export const personalInfo = {
  ...
  description:
    'Computer Engineering student at the University of Toronto with hands on experience in full stack development, machine learning based perception systems, and research driven data visualization. Passionate about building scalable solutions and leading teams to solve meaningful problems.',
  university: 'University of Toronto',
  degree: 'Bachelor of Applied Science & Engineering in Computer Engineering',
...
export const aboutData = {
  paragraphs: [
    'I am a Computer Engineering student at the University of Toronto who thrives on building software that solves real problems, from emergency route optimization to machine learning powered cone detection for autonomous racing. I bring a research driven mindset, strong leadership instincts, and a relentless curiosity to every project I touch.',
    'Beyond the classroom, I have contributed to industry SaaS platforms, authored technical reports on healthcare data visualization, and led multidisciplinary engineering design teams. When I am not coding, you will find me on the tennis court, volunteering, or exploring the outdoors.',
  ],
  stats: [
...
export const experienceData = [
  ...
  },
  {
    ...
    description:
      'UTOSS is a design team at the University of Toronto that develops and contributes to real world open source software and hardware projects. As a member of the software team, I contribute to major open source projects including Firefox, Knative, and Kubernetes, with potential contributions to Linux and PyTorch. The team runs both long term and short term projects, fostering skills in software development, open source tooling, and collaborative engineering in a real world open source environment.',
    tags: ['Open Source', 'Firefox', 'Knative', 'Kubernetes', 'Linux', 'PyTorch'],
    type: 'work',
  },
  {
    id: 3,
    role: 'Research Assistant',
    company: 'University of Toronto with Prof. Clement C. Zai',
    location: 'Toronto, ON',
    period: 'Nov 2024 to Feb 2025',
    description:
      'Conducted research on pharmacogenetic reporting and data visualization in mental healthcare. Developed AI powered clinical dashboards and decision support tools using large language models, and authored a technical report proposing scalable, data driven visualization design recommendations.',
  ...
  },
  {
    ...
    period: 'Jan 2026 to Present',
    description:
      'Working on machine learning based perception for cone detection, classification, and localization using camera image streams. Contributing to data collection and manual labeling to improve model generalization, and evaluating models using IoU, mAP, and inference latency under real time NVIDIA Jetson constraints.',
    tags: ['Python', 'Machine Learning', 'Computer Vision', 'NVIDIA Jetson'],
    type: 'work',
  },
  {
    id: 5,
